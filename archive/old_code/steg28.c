...
// --- OPTIMALISERING: Redusert arbeidsmengde! ---
#define SAMPLES_PER_SYMBOL_TX 50  
#define SAMPLES_PER_SYMBOL_RX 2    // Redusert fra 5 til 2!
#define DECIMATION_FACTOR 25       // Økt fra 10 til 25 (Hopper over mye mer data)

#define TX_BUFFER_SAMPLES 65536 
// Gjort om til 10000 slik at det går matematisk perfekt opp i 25
...
void *rx_thread_func(void *arg) {
    ...
    while (keep_running) {
        ...
        // --- DEN STORE CPU-FIKSEN ---
        // Vi hopper brutalt over minnet i store steg! 
        ptrdiff_t fast_forward = p_inc * DECIMATION_FACTOR;
        
        // Loopen kjører nå bare 100 000 ganger i sek (mot 2.5 millioner før!)
