...
void *rx_thread_func(void *arg) {
    ...
    // --- DSP Oppsett ---
    iirfilt_crcf qdc = iirfilt_crcf_create_dc_blocker(0.01f); // Fjerner DC-spike
...
int main() {
    ...
    iio_channel_attr_write_longlong(tx_chan, "sampling_frequency", 2000000);
    ...
    iio_channel_attr_write_longlong(rx_chan, "sampling_frequency", 2000000);
    ...
    // Kjører sikkerhetssjekken før vi går videre
